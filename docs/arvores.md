...
Neste caso, sim, há uma melhora no desempenho. No entanto, teoricamente, não é bem assim, porque, dependendo da estrutura da fórmula, se ela incluir n proposições atômicas, a árvore pode gerar  $2^{n}$ nós-folha, aqueles apenas com literais complementares. Se acontecer desta fórmula ser insatisfazível -- o pior caso -- o algoritmo vai acabar fazendo o mesmo número de testes que seriam realizados em uma tabela-verdade. De novo, um horror!
